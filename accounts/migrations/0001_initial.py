    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "email_verified",
                    models.BooleanField(default=False, verbose_name="ایمیل تأیید شده"),
                ),
                (
                    "created_at",
                    models.DateTimeField(auto_now_add=True, verbose_name="تاریخ ایجاد"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "experience",
                    models.TextField(
                        blank=True, null=True, verbose_name="سوابق و تجربیات"
                    ),
                ),
                (
                    "price",
                ...
                (
                    "teaching_method",
                    models.TextField(blank=True, null=True, verbose_name="روش تدریس"),
                ),
                (
                    "capacity",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="ظرفیت هنرجو"
                    ),
                ),
                (
                    "trial_session",
