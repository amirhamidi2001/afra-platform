  ...
  return (
    <section className="py-16 px-4 bg-white">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8">
        <div
          className="bg-emerald-600 text-white p-8 rounded-lg"
          data-aos="fade-up"
          data-aos-delay="100"
        >
          ...
          <div className="mt-6 text-center">
            <a
              href="#"
              className="inline-block bg-white text-emerald-600 px-6 py-2 rounded-full font-semibold hover:bg-gray-100"
            >
              بیشتر بدانید
            </a>
          </div>
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          <div
            ...
            data-aos-delay="200"
          >
            <i className="bi bi-clipboard-data text-4xl text-emerald-600"></i>
          ...
          <div
            ...
            data-aos-delay="300"
          >
            <i className="bi bi-gem text-4xl text-emerald-600"></i>
          ...
          <div
            ...
            data-aos-delay="400"
          >
            <i className="bi bi-inboxes text-4xl text-emerald-600"></i>
